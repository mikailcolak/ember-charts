...
var countBars = function () {
  return document.querySelectorAll('.chart-time-series svg g.bars').length;
};

var countRects = function () {
  return document.querySelectorAll('.chart-time-series svg rect').length;
};

module('Acceptance | time-series', function (hooks) {
  ...
  test("it exists", function (assert) {
    assert.dom('.chart-time-series').exists();
  });
